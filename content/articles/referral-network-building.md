---
title: "Building a Referral Network: Collaborating with Psychiatrists and Primary Care"
slug: "referral-network-building"
excerpt: "A strategic guide for ketamine practitioners on developing productive referral relationships with psychiatrists and primary care physicians, including approaches for initial outreach, communication protocols, shared care models, and maintaining long-term collaborative partnerships."
...
| Source | % of Referrals | Characteristics |
|--------|---------------|-----------------|
| Psychiatrists | 40-60% | Most clinically aligned; understand treatment resistance |
| Primary Care | 20-30% | Large patient base; variable mental health comfort |
| Therapists/Psychologists | 10-20% | Cannot prescribe but identify treatment-resistant patients |
| Self-Referral | 10-20% | Internet research; may need most education |
...
1. Research local psychiatrists and their specialties
2. Identify practices with large depression caseloads
3. Note existing referral patterns (who refers to whom)
4. Consider geographic convenience for patients
5. Identify opinion leaders and influencers
...
**Meeting Objectives**:
1. Establish personal connection and rapport
2. Assess their current referral needs and patterns
3. Educate about ketamine therapy (briefly, appropriately)
4. Address specific concerns they may have
...
| Phase | Communication | Timing |
|-------|---------------|--------|
| Pre-treatment | Evaluation summary | Within 48 hours of eval |
| Acute series | Treatment updates | After every 2-3 sessions |
| End of acute | Outcome summary | Within 1 week of completion |
| Maintenance | Progress updates | Monthly or with any concerns |
...
**Flow**:
1. Referring provider identifies potential candidate
2. Ketamine provider evaluates and recommends
3. Ketamine treatment provided
4. Patient returns to referring provider's care
5. Ketamine provider available for ongoing consultation
...
**Flow**:
1. Referring provider maintains psychiatric care (medications, therapy coordination)
2. Ketamine provider manages ketamine treatment specifically
3. Regular communication between providers
4. Shared decision-making on treatment adjustments
...
**Flow**:
1. Psychiatry and ketamine services co-located
2. Shared EHR and team meetings
3. Seamless coordination and communication
4. Truly unified treatment approach
...
1. Acknowledge the gap proactively
2. Re-establish communication protocols
3. Over-communicate temporarily
4. Discuss what went wrong

**When Outcomes Disappoint**:
1. Be transparent about results
2. Discuss clinical reasoning
3. Collaborate on next steps
4. Learn from the case together

**When Conflicts Arise**:
1. Address directly and promptly
...
**Approach**:
1. Connected with department chair through mutual colleague
2. Offered grand rounds presentation on ketamine evidence
3. Provided detailed referral protocol and patient selection guide
4. Assigned single point of contact for the department
5. Quarterly case conferences with interested faculty
...
**Approach**:
1. Sent introduction letter highlighting collaborative model
2. Requested brief meeting with medical director
3. Addressed concerns about patient retention
4. Provided detailed communication protocols
5. Monthly lunch meetings with practice providers
...
**Approach**:
1. Identified behavioral health integration coordinator
2. Provided educational materials for primary care audiences
3. Created simple referral criteria and process
4. Offered consult phone line for questions
5. Quarterly newsletter with educational content
...
1. **Understand Referrer Needs**: Successful referral relationships are built on understanding what referring providers need - knowledge, trust, communication, and ongoing involvement.

2. **Lead with Value**: Approach referral building by offering value (education, resources, expertise) rather than asking for referrals. The referrals follow trust.

3. **Communicate Relentlessly**: Over-communication is rarely criticized; under-communication frequently is. Build communication protocols and follow them consistently.

4. **Address the "Losing Patients" Concern**: Many providers fear referring will mean losing the patient relationship. Proactively address this with clear shared care models.

5. **Make Referral Easy**: Simple referral processes, clear criteria, and responsive scheduling remove barriers to referral.

6. **Build Personal Relationships**: Beyond professional protocols, personal relationships drive referral behavior. Invest in getting to know referrers.

7. **Demonstrate Quality**: Outcome tracking and communication of results differentiates your practice and builds referrer confidence.

8. **Maintain What You Build**: Referral relationships require ongoing maintenance. Schedule regular touch points and never take relationships for granted.

9. **Scale Thoughtfully**: Build deep relationships before broad ones. A small number of strong referral relationships often outperforms a large number of shallow ones.

10. **Be Patient**: Trust-based referral relationships take time to develop. Expect 6-12 months to see significant referral volume from new relationships.
