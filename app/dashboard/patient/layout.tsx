...
const navigation = [
  ...
  { name: 'Saved Providers', href: '/dashboard/patient/saved', icon: HeartIcon },
  { name: 'Consultations', href: '/dashboard/patient/consultations', icon: CalendarIcon },
  { name: 'Courses', href: '/dashboard/patient/courses', icon: BookIcon },
  { name: 'Settings', href: '/dashboard/patient/settings', icon: SettingsIcon },
];
          ...
          <div className="flex flex-1 gap-x-4 self-stretch lg:gap-x-6">
            ...
            <div className="flex items-center gap-x-4 lg:gap-x-6">
              ...
              <div className="flex items-center gap-x-3">
                <div className="flex h-9 w-9 items-center justify-center rounded-full bg-teal-100 text-teal-700 font-medium">
