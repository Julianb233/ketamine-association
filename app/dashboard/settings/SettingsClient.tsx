...
export default function SettingsClient({ membership, userEmail }: SettingsClientProps) {
  // Default notification settings - in a real app, these would be fetched from the database
  ...
  const tierKey = membership.tier as keyof typeof MEMBERSHIP_TIERS;
  ...
  const leadsUsed = membership.leadsUsedThisMonth;

  const daysUntilRenewal = membership.expiresAt
  ...
  return (
    <div className="space-y-6">
          ...
          <div className="relative">
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-6">
              ...
              <div className="bg-white/10 rounded-xl p-4">
                ...
                <p className="text-xl font-bold">{membership.status}</p>
              </div>
              <div className="bg-white/10 rounded-xl p-4">
                <div className="flex items-center gap-2 mb-1">
              ...
              <div className="bg-white/10 rounded-xl p-4">
                ...
                <p className="text-xl font-bold">${tierInfo.monthlyPrice}</p>
              </div>
            </div>

            {/* Progress bar for leads */}
            {typeof leadsLimit === 'number' && (
              <div className="mb-6">
                ...
                <div className="h-2 bg-white/20 rounded-full overflow-hidden">
                  <div
                    ...
                    style={{ width: `${Math.min(100, (leadsUsed / leadsLimit) * 100)}%` }}
                  />
                </div>
              </div>
            )}
      ...
      {/* Upgrade Section */}
      {membership.tier !== 'ELITE' && membership.tier !== 'ENTERPRISE' && (
                ...
                Object.entries(MEMBERSHIP_TIERS)
                  ...
                  .map(([tier, info]) => (
                    <MembershipCard
                      ...
                      isCurrentPlan={tier === membership.tier}
