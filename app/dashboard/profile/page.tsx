...
const mockProfile: ProfileFormData = {
  ...
  bio: 'Board-certified psychiatrist specializing in ketamine therapy for treatment-resistant depression and chronic pain conditions. Over 15 years of experience in mental health treatment.',
  practiceName: 'Mindful Ketamine Clinic',
  address: '123 Medical Center Drive, Suite 400',
  city: 'San Francisco',
  state: 'CA',
  zipCode: '94102',
  phone: '(415) 555-0123',
  website: 'https://mindfulketamine.com',
  licenseNumber: 'MD123456',
  licenseState: 'CA',
  npiNumber: '1234567890',
  treatments: ['IV_INFUSION', 'KETAMINE_ASSISTED_PSYCHOTHERAPY'],
  conditions: ['TREATMENT_RESISTANT_DEPRESSION', 'PTSD', 'ANXIETY'],
  insurances: ['Blue Cross Blue Shield', 'Aetna', 'Self-Pay'],
};
