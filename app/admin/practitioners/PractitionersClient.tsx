...
interface PractitionersClientProps {
...
export default function PractitionersClient({ practitioners }: PractitionersClientProps) {
      ...
      <div className="grid grid-cols-2 gap-4 lg:grid-cols-4">
        <div className="bg-slate-900 rounded-xl border border-slate-800 p-4">
          <div className="flex items-center gap-3">
            ...
            <div>
              <p className="text-2xl font-bold text-white">{practitioners.length}</p>
          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              <p className="text-2xl font-bold text-white">
                {practitioners.filter((p) => p.isVerified).length}
              </p>
        ...
        <div className="bg-slate-900 rounded-xl border border-slate-800 p-4">
          <div className="flex items-center gap-3">
            ...
            <div>
              <p className="text-2xl font-bold text-white">
                {practitioners.filter((p) => p.isFeatured).length}
              </p>
      ...
      <div className="bg-slate-900 rounded-xl border border-slate-800 overflow-hidden">
                    ...
                    <td className="px-6 py-4">
                      <div className="flex items-center gap-3">
                        ...
                        <div>
                          ...
                          <p className="text-xs text-slate-500">{practitioner.practice || 'No practice name'}</p>
                        </div>
                      </div>
                    </td>
                    <td className="px-6 py-4">
                      {practitioner.city || practitioner.state ? (
                        ...
                        <span className="text-sm text-slate-500">No location</span>
                      )}
                    </td>
                    <td className="px-6 py-4">
                      <span
                    ...
                    <td className="px-6 py-4">
                      {practitioner.rating > 0 ? (
                        <div className="flex items-center gap-1.5">
                          ...
                          <span className="text-sm font-medium text-white">{practitioner.rating.toFixed(1)}</span>
        ...
        {filteredPractitioners.length === 0 && (
          <div className="p-12 text-center">
            ...
            <h3 className="text-lg font-semibold text-white mb-2">No practitioners found</h3>
            <p className="text-slate-400 text-sm">
              {practitioners.length === 0
                ? 'There are no practitioners in the system yet.'
        ...
        {filteredPractitioners.length > 0 && (
          <div className="flex items-center justify-between px-6 py-4 border-t border-slate-800">
            <p className="text-sm text-slate-400">
              ...
              <span className="font-medium text-white">{practitioners.length}</span> practitioners
            </p>
            <div className="flex items-center gap-2">
