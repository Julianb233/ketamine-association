...
const mockArticles: Article[] = [
  {
    id: '1',
    title: 'Advances in Ketamine-Assisted Psychotherapy for PTSD',
    slug: 'advances-ketamine-assisted-psychotherapy-ptsd',
    ...
    excerpt: 'New research shows promising results in treating PTSD with ketamine-assisted therapy...',
  },
  {
    id: '2',
    title: 'FDA Updates on Esketamine Regulations 2024',
    slug: 'fda-updates-esketamine-regulations-2024',
    author: 'Admin Team',
    ...
    excerpt: 'The FDA has announced new guidelines for esketamine prescriptions...',
  },
  {
    id: '3',
    title: 'Building a Successful Ketamine Practice: A Guide',
    slug: 'building-successful-ketamine-practice-guide',
    ...
    excerpt: 'Essential strategies for establishing and growing your ketamine therapy practice...',
  },
  {
    id: '4',
    title: 'My Journey Through Treatment-Resistant Depression',
    slug: 'my-journey-treatment-resistant-depression',
    author: 'Emily J. (Patient)',
    category: 'PATIENT_STORIES',
    status: 'DRAFT',
    views: 0,
    publishedAt: null,
    createdAt: '2024-01-17',
    excerpt: 'After years of failed treatments, ketamine therapy changed my life...',
  },
  {
    id: '5',
    title: 'New IV Infusion Protocols Show Improved Outcomes',
    slug: 'new-iv-infusion-protocols-improved-outcomes',
    author: 'Dr. Lisa Park',
    ...
    excerpt: 'Recent studies indicate that modified infusion protocols can enhance treatment efficacy...',
  },
  {
    id: '6',
    title: 'Industry Trends: The Future of Ketamine Therapy',
    slug: 'industry-trends-future-ketamine-therapy',
    ...
    excerpt: 'Market analysis and predictions for the ketamine therapy industry...',
  },
  {
    id: '7',
    title: 'Understanding Ketamine Dosing Guidelines',
    slug: 'understanding-ketamine-dosing-guidelines',
    ...
    excerpt: 'A comprehensive guide to ketamine dosing for various treatment protocols...',
  },
  {
    id: '8',
    title: 'Archived: 2023 Year in Review',
    slug: 'archived-2023-year-review',
    author: 'Admin Team',
    category: 'INDUSTRY_NEWS',
    status: 'ARCHIVED',
    views: 456,
    ...
    excerpt: 'A look back at the major developments in ketamine therapy throughout 2023...',
  },
];
...
export default function ArticlesManagementPage() {
  ...
  const statusCounts = {
    pending: mockArticles.filter((a) => a.status === 'PENDING_REVIEW').length,
    revision: mockArticles.filter((a) => a.status === 'REVISION_NEEDED').length,
      ...
      <div className="bg-slate-900 rounded-xl border border-slate-800 overflow-hidden">
        ...
        <div className="flex items-center justify-between px-6 py-4 border-t border-slate-800">
          <p className="text-sm text-slate-400">
            ...
            <span className="font-medium text-white">{mockArticles.length}</span> articles
          </p>
