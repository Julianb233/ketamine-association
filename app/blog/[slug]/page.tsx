...
// Convert ArticleCardType to Article for the component
...
export async function generateMetadata({ params }: { params: Promise<{ slug: string }> }): Promise<Metadata> {
  ...
  const article = await getArticleBySlugWithHtml(slug);
...
export default async function ArticlePage({ params }: { params: Promise<{ slug: string }> }) {
  ...
  const relatedCards = await getRelatedArticles(slug, 3);
  const relatedArticles = relatedCards.map(convertToArticle);

  const displayCategory = CATEGORY_DISPLAY_NAMES[article.category] || article.category;
  const badgeVariant = categoryBadgeVariants[displayCategory] || 'default';
  ...
  return (
    <>
          ...
          <div className="flex flex-wrap items-center gap-6">
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-sm text-slate-500">Ketamine Association</p>
              </div>
            </div>
          ...
          <div className="grid lg:grid-cols-[1fr_auto] gap-12">
            ...
            <article
              className="prose prose-lg prose-slate max-w-none
                ...
                prose-blockquote:bg-teal-50 prose-blockquote:py-4 prose-blockquote:px-6
      ...
      {/* CTA Section */}
      <section className="py-16 bg-gradient-to-br from-teal-600 via-teal-700 to-emerald-800">
        <Container>
          <div className="text-center text-white">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <Button href="/blog" variant="outline" size="lg" className="border-white text-white hover:bg-white hover:text-teal-700">
                Browse All Articles
              </Button>
              <Button href="/association/membership" variant="amber" size="lg">
